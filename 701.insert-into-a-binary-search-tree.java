...
class Solution {
    ...
    // Time: O(logn)
    // Space: O(1)
    // Do not edit root, do the iteration of the curNode.
    // Reference: https://www.cnblogs.com/Dylan-Java-NYC/p/11015910.html
    private TreeNode iterativeSolution(TreeNode root, int val) {
        ...
        while (curNode != null) {
            if (curNode.val < val) { // move to right
                // Corner Case
    ...
    // Time: O(logn)
    // Space: O(h)
    // Keep the root and do the recursion of left/right nodes.
    // Reference: https://blog.csdn.net/Tc_To_Top/article/details/104367184
